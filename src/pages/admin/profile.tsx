export default function ProfilePage() {
  return (
    <div className="overflow-hidden rounded-sm bg-white shadow-lg lg:mx-20">
      ...
      <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
        <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
          <div className="relative drop-shadow-2">
            <img src={"/images/user-06.png"} alt="profile" />
            <label
              htmlFor="profile"
        ...
        <div className="mt-4">
          ...
          <div className="mx-auto mt-4.5 mb-5.5 grid max-w-94 grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark">
